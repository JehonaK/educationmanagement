...
export class SchoolClassService {
  ...
  createSchoolClass(schoolClass: SchoolClassModel): Observable<SchoolClassModel> {
  ...
  addStudentToClass(email: string) {
    return this.http.post(ENDPOINTS.school.addStudentToClass, email);
  }
}
